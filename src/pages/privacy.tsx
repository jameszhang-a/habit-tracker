...
const Privacy: NextPage = () => {
  return (
    <div className="container mx-auto">
      <h1 className="my-2 mt-4 text-5xl font-bold">Privacy Policy</h1>
      <p className="mb-3">Last updated: March 21, 2023</p>
      <p className="mb-3">
      ...
      <h1 className="my-2 mt-4 text-3xl font-bold">
        Interpretation and Definitions
      </h1>
      <h2 className="m-1 text-2xl font-semibold">Interpretation</h2>
      <p className="mb-3">
      ...
      <h2 className="m-1 text-2xl font-semibold">Definitions</h2>
      ...
      <ul className="ml-6 mb-2 list-disc">
        ...
        <li>
          <p className="mb-3">
            ...
            this Agreement) refers to Habit Genie.
          </p>
        </li>
        <li>
          <p className="mb-3">
        ...
        <li>
          <p className="mb-3">
            <strong>Website</strong> refers to Habit Genie, accessible from{" "}
            <a
              href="https://habitgenie.vercel.app/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://habitgenie.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <h2 className="m-1 text-2xl font-semibold">Types of Data Collected</h2>
      <h3 className="text-semibold text-xl text-slate-700">Personal Data</h3>
      <p className="mb-3">
      ...
      <h3 className="text-semibold text-xl text-slate-700">Usage Data</h3>
      <p className="mb-3">
      ...
      <h3 className="text-semibold text-xl text-slate-700">
      ...
      <h2 className="m-1 text-2xl font-semibold">Use of Your Personal Data</h2>
      <p className="mb-3">
      ...
      <h2 className="font-semiold text-2xl">
        mb-1 Retention of Your Personal Data
      </h2>
      <p className="mb-3">
      ...
      <h2 className="m-1 text-2xl font-semibold">
      ...
      <h2 className="m-1 text-2xl font-semibold">Delete Your Personal Data</h2>
      <p className="mb-3">
      ...
      <h2 className="font-semiold text-2xl">
        mb-1 Disclosure of Your Personal Data
      </h2>
      <h3 className="text-semibold text-xl text-slate-700">
      ...
      <h3 className="text-semibold text-xl text-slate-700">Law enforcement</h3>
      <p className="mb-3">
      ...
      <h1 className="my-2 mt-4 text-3xl font-bold">Children&apos;s Privacy</h1>
      <p className="mb-3">
      ...
      <h1 className="my-2 mt-4 text-3xl font-bold">Links to Other Websites</h1>
      <p className="mb-3">
      ...
      <h1 className="my-2 mt-4 text-3xl font-bold">Contact Us</h1>
      <p className="mb-3">
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul className="ml-6 mb-2 list-disc">
        <li>By email: jameszhanga@gmail.com</li>
      </ul>
    </div>
  );
};
